...
<html lang="pt-br">
  ...
  <?php
    ...
    if (!$linha['foto'])
      $linha['foto'] = 'default-profile.png';
  ...
  ?>
    ...
    <div class="container">
      <div class="row">
        <div class="col-md-10">
          <h1>Cadastro Edição</h1> 
        </div>
        <div class="col-md-2 d-flex justify-content-md-end align-items-md-center">
          <a href="pesquisa.php" class="btn btn-primary mt-2">Voltar</a>
        </div>
      </div>
              ...
              <div class="card border-0">
                <div class="card-body">
                  <div class="d-flex flex-column align-items-center text-center"> 
                    <img src="<?php echo 'img/' .$linha['foto']; ?>" id="profilePicture" alt="Admin" class="rounded-circle" width="120">
                  </div>
                </div>
              </div>
            </div>
